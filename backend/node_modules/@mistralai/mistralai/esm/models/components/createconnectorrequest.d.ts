...
export type CreateConnectorRequestAuthMethod = BearerAuthMethod | NoneAuthMethod | (OAuth2AuthMethod & {
    methodType: "oauth2";
});
...
/** @internal */
export type CreateConnectorRequestAuthMethod$Outbound = BearerAuthMethod$Outbound | NoneAuthMethod$Outbound | (OAuth2AuthMethod$Outbound & {
    method_type: "oauth2";
});
/** @internal */
export declare const CreateConnectorRequestAuthMethod$outboundSchema: z.ZodType<CreateConnectorRequestAuthMethod$Outbound, CreateConnectorRequestAuthMethod>;
export declare function createConnectorRequestAuthMethodToJSON(createConnectorRequestAuthMethod: CreateConnectorRequestAuthMethod): string;
/** @internal */
