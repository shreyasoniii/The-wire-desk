...
/** @internal */
export declare const MCPConnector$inboundSchema: z.ZodType<MCPConnector, unknown>;
export declare function mcpConnectorFromJSON(jsonString: string): SafeParseResult<MCPConnector, SDKValidationError>;
