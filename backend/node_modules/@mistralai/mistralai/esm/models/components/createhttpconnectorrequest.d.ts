...
import { PublicResourceVisibility } from "./publicresourcevisibility.js";
export type CreateHTTPConnectorRequestAuthMethod = BearerAuthMethod | NoneAuthMethod | (OAuth2AuthMethod & {
    methodType: "oauth2";
});
export type CreateHTTPConnectorRequest = {
     ...
     */
    authMethods?: Array<BearerAuthMethod | NoneAuthMethod | (OAuth2AuthMethod & {
        methodType: "oauth2";
    })> | null | undefined;
    /**
...
/** @internal */
export type CreateHTTPConnectorRequestAuthMethod$Outbound = BearerAuthMethod$Outbound | NoneAuthMethod$Outbound | (OAuth2AuthMethod$Outbound & {
    method_type: "oauth2";
});
/** @internal */
export declare const CreateHTTPConnectorRequestAuthMethod$outboundSchema: z.ZodType<CreateHTTPConnectorRequestAuthMethod$Outbound, CreateHTTPConnectorRequestAuthMethod>;
export declare function createHTTPConnectorRequestAuthMethodToJSON(createHTTPConnectorRequestAuthMethod: CreateHTTPConnectorRequestAuthMethod): string;
/** @internal */
export type CreateHTTPConnectorRequest$Outbound = {
    ...
    auth_methods?: Array<BearerAuthMethod$Outbound | NoneAuthMethod$Outbound | (OAuth2AuthMethod$Outbound & {
        method_type: "oauth2";
    })> | null | undefined;
...
/** @internal */
export declare const CreateHTTPConnectorRequest$outboundSchema: z.ZodType<CreateHTTPConnectorRequest$Outbound, CreateHTTPConnectorRequest>;
export declare function createHTTPConnectorRequestToJSON(createHTTPConnectorRequest: CreateHTTPConnectorRequest): string;
//# sourceMappingURL=createhttpconnectorrequest.d.ts.map