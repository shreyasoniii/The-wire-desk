...
export class Connectors extends ClientSDK {
     ...
     */
    async unshare(request, options) {
        return unwrapAsync(betaConnectorsUnshare(this, request, options));
    }
    /**
     ...
     */
    async shareToOrganization(request, options) {
        return unwrapAsync(betaConnectorsShareToOrganization(this, request, options));
    }
    /**
     ...
     */
    async unshareFromOrganization(request, options) {
        return unwrapAsync(betaConnectorsUnshareFromOrganization(this, request, options));
    }
    /**
     ...
     */
    async activateForConsumer(request, options) {
        return unwrapAsync(betaConnectorsActivateForConsumer(this, request, options));
    }
    /**
     ...
     */
    async deactivateForConsumer(request, options) {
        return unwrapAsync(betaConnectorsDeactivateForConsumer(this, request, options));
    }
    /**
     * Call Connector Tool
     *
     ...
     */
    async createCredentials(request, options) {
        return unwrapAsync(betaConnectorsCreateCredentials(this, request, options));
    }
    /**
     ...
     */
    async updateCredentials(request, options) {
        return unwrapAsync(betaConnectorsUpdateCredentials(this, request, options));
    }
    /**
