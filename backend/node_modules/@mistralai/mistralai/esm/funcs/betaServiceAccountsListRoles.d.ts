 ...
 */
export declare function betaServiceAccountsListRoles(client: MistralCore, request: operations.ListServiceAccountRolesV1ServiceAccountsServiceAccountIdRolesGetRequest, options?: RequestOptions): APIPromise<Result<components.ListServiceAccountRolesResponse, errors.HTTPValidationError | MistralError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
//# sourceMappingURL=betaServiceAccountsListRoles.d.ts.map