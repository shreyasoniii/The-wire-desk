 ...
 */
export function betaUsersListOrganizations(client, security, request, options) {
    return new APIPromise($do(client, security, request, options));
}
async function $do(client, security, request, options) {
    const parsed = safeParse(request, (value) => operations.UsersApiListOrganizationsRequest$outboundSchema.optional()
    ...
    const [result, raw] = await M.match(M.json(200, operations.UsersApiListOrganizationsResponse$inboundSchema, {
        key: "Result",
    ...
    const nextFunc = (responseData) => {
        ...
        const nextVal = () => betaUsersListOrganizations(client, security, {
            ...request,
            offset: nextOffset,
        }, options);
...
//# sourceMappingURL=betaUsersListOrganizations.js.map